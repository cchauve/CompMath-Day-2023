...
# - the results obtained by MOB-recon,
...
# - E_faecalis_MOB-recon_F1.csv, E_faecium_MOB-recon_F1.csv
#
# It would use the python script ${REPO_HOME}/bin/MOB-recon_utils.py
